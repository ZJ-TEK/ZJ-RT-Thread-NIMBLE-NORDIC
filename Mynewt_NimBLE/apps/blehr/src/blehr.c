...
static const char *device_name = "rtthread-open-ble";
...
static ble_uuid16_t m_adv_uuids[] =
{
...
blehr_tx_hrate_reset(void)
{
    ...
    rc = ble_npl_callout_reset(&blehr_tx_timer, RT_TICK_PER_SECOND/4);
    assert(rc == 0);
}
...
blehr_tx_hrate(struct ble_npl_event *ev)
{
    ...
    static uint8_t hrm_change_flag = 1;
